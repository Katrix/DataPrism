...
trait DefaultOperationSqlQueryPlatform extends SqlQueryPlatformOperation { platform: SqlQueryPlatform =>
  ...
  override given sqlDeleteOperationLift[A[_[_]], B[_[_]]]: Lift[SqlDeleteOperationImpl[A, B], SqlDeleteOperation[A, B]] = Lift.subtype
  override given sqlDeleteReturningOperationLift[A[_[_]], B[_[_]], C[_[_]]]: Lift[SqlDeleteReturningOperationImpl[A, B, C], SqlDeleteReturningOperation[A, B, C]] = Lift.subtype
  ...
  override given sqlDeleteFromUsingLift[A[_[_]], B[_[_]]]: Lift[SqlDeleteFromUsingImpl[A, B], SqlDeleteFromUsing[A, B]] = Lift.subtype
  override given sqlInsertOperationLift[A[_[_]], B[_[_]]]: Lift[SqlInsertOperationImpl[A, B], SqlInsertOperation[A, B]] = Lift.subtype
  override given sqlInsertReturningOperationLift[A[_[_]], B[_[_]], C[_[_]]]: Lift[SqlInsertReturningOperationImpl[A, B, C], SqlInsertReturningOperation[A, B, C]] = Lift.subtype
  ...
  override given sqlUpdateOperationLift[A[_[_]], B[_[_]], C[_[_]]]: Lift[SqlUpdateOperationImpl[A, B, C], SqlUpdateOperation[A, B, C]] = Lift.subtype
  override given sqlUpdateReturningOperationLift[A[_[_]], B[_[_]], C[_[_]], D[_[_]]]: Lift[SqlUpdateReturningOperationImpl[A, B, C, D], SqlUpdateReturningOperation[A, B, C, D]] = Lift.subtype
  ...
  override given sqlUpdateTableFromLift[A[_[_]], C[_[_]]]: Lift[SqlUpdateTableFromImpl[A, C], SqlUpdateTableFrom[A, C]] = Lift.subtype
  override given sqlUpdateTableWhereLift[A[_[_]]]: Lift[SqlUpdateTableWhereImpl[A], SqlUpdateTableWhere[A]] = Lift.subtype
  override given sqlUpdateTableFromWhereLift[A[_[_]], C[_[_]]]: Lift[SqlUpdateTableFromWhereImpl[A, C], SqlUpdateTableFromWhere[A, C]] = Lift.subtype
